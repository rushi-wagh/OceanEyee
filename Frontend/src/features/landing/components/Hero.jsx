      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-navy-950 border border-white/5 text-slate-300 text-xs font-semibold tracking-wide mb-8 shadow-inner"
          >
            <span className="w-2 h-2 rounded-full bg-accent animate-pulse"></span>
            OceanEye Operations Portal Active
          </motion.div>
          ...
          >
            Connect citizens, dispatchers, and environmental response teams on a
            single coordinate-based network. Ingest incident reports, verify
            hazards, and track response workflows live.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-slate-300 font-medium">GPS Pinpointing</p>
              </div>
            </div>
            <div className="flex items-center gap-3 justify-center">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-slate-300 font-medium">Verification History</p>
              </div>
            </div>
            <div className="col-span-2 md:col-span-1 flex items-center gap-3 justify-center md:justify-end">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-slate-300 font-medium">Live Incident Status</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
