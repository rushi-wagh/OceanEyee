...
console.log("[DEV] CitizenDashboard (citizen folder) module loaded");
    ...
    <main className="min-h-screen bg-background bg-grid-pattern px-6 py-12 text-slate-100">
      <div className="mx-auto max-w-5xl">
        <div className="flex items-start justify-between gap-6">
          <div>
            <h1 className="text-4xl font-extrabold text-white">Citizen Dashboard</h1>
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="glass-panel card-glow rounded-2xl p-6 shadow-glow-primary">
